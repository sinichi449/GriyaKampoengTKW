...
object FirebaseNodes {
    const val KEY_BACKUP_NAME = "NAMA_BACKUP"
    ...
    fun DatabaseReference.backupNodeOf(backupName: String, node: String): DatabaseReference {
        return this.child("$BACKUPS/$backupName/$node")
    }
}