...
// Mapper
fun StandardAmbilKuitansiEntity.toAmbilKuitansiModel(): StandardAmbilKuitansiModel {
    return this.let {
...
fun StandardAmbilKuitansiModel.toAmbilKuitansiEntity(): StandardAmbilKuitansiEntity {
    return this.let {
