...
import net.bagusekasaputra.griyakampoeng.tkw.data.local.model.toIndenBookingCatatanPembayaranEntity
import net.bagusekasaputra.griyakampoeng.tkw.data.local.model.toIndenBookingCatatanPembayaranModel
...
class RoomIndenBookingCatatanPembayaranDataSource(
    ...
    override suspend fun get(keyId: String): Result<IndenBookingCatatanPembayaranModel?> {
        return roomOperation {
            ...
            entity?.toIndenBookingCatatanPembayaranEntity()
        }
    }
    ...
    override suspend fun insert(model: IndenBookingCatatanPembayaranModel): Result<Nothing?> {
        return roomOperation {
            ...
            // Then insert
            catatanPembayaranDao.insert(model.toIndenBookingCatatanPembayaranModel())
