...
import net.bagusekasaputra.griyakampoeng.tkw.data.local.model.toAmbilKuitansiEntity
import net.bagusekasaputra.griyakampoeng.tkw.data.local.model.toAmbilKuitansiModel
...
class RoomStandardAmbilKuitansiDataSource(
    ...
    override suspend fun update(model: StandardAmbilKuitansiModel): Result<Nothing?> {
        return roomOperation {
            ...
            dao.insert(model.toAmbilKuitansiEntity())
