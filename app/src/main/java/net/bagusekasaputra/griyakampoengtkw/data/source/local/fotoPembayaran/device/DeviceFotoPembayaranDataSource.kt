...
@Singleton
class DeviceFotoPembayaranDataSource @Inject constructor(
    ...
    override suspend fun deleteAllFotoPembayaran(kavlingKode: String): Result<Nothing?> {
        val filePath = File(externalFilesDir, "${Environment.DIRECTORY_PICTURES}/${GriyaNodes.fotoPembayaranFilePath}")
