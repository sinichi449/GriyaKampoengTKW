package net.bagusekasaputra.griyakampoengtkw.di.usecase
...
object UseCaseModule {
     ...
     */
    @Provides
    fun provideGetHargaKavling(hargaKavlingRepository: HargaKavlingRepository): GetHargaKavlingUseCase {
        return GetHargaKavlingUseCase(hargaKavlingRepository)
    }
    ...
    fun provideGetFeeMarketingByKavlingKode(feeMarketingRepository: FeeMarketingRepository)
        = GetFeeMarketingByKavlingKode(feeMarketingRepository)
    ...
    fun provideGetCatatanPembayaran(catatanPembayaranRepository: CatatanPembayaranRepository)
        = GetCatatanPembayaranUseCase(catatanPembayaranRepository)
